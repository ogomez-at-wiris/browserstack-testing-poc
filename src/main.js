...
const firefoxTestRunner = new TestRunner(Capabilities.FIREFOX)
firefoxTestRunner.runTest()

const chromeTestRunner = new TestRunner(Capabilities.CHROME)
chromeTestRunner.runTest()

const safariTestRunner = new TestRunner(Capabilities.SAFARI)
safariTestRunner.runTest()
